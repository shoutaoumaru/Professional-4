    ...
    <main id="main-contents">
      ...
      <section class="p-services">
        <div class="c-container">
          ...
          <div class="p-services__desc">
            <p class="c-txt-sm">Riv司法書士事務所は高い専門知識とサポート力で、ご満足頂けるサービスをお約束します。</p>
          </div>
      ...
      <section class="p-price">
        <div class="c-container">
          ...
          <div class="p-price__desc">
            <p class="c-txt-sm">
              Riv司法書士事務所は高い専門知識とサポート力を兼ね備えながら、ご依頼頂きやすい様に、分かりやすい料金体系を心がけております。
            </p>
          </div>
          <div class="more-btn">
          ...
          <div class="p-recruit__wrap">
            <div class="p-recruit__txt">
              ...
              <div class="p-recruit__desc item">
                <p class="c-txt-sm">
                  Riv司法書士事務所は、通年で中途採用を実施しています。<br>これまでの経験を生かして活躍したい方や、<br>新たなフィールドで知識やスキルを身につけたい方のエントリーをお待ちしています
                </p>
              </div>
